...
class VERTEXCOLORMASTER_OT_BlurChannel(bpy.types.Operator):
    ...
    def execute(self, context):
        obj = context.active_object
        mesh = obj.data
        vcol = mesh.color_attributes.active_color if mesh.color_attributes else mesh.color_attributes.new("Col", 'BYTE_COLOR', 'CORNER')
...
class VERTEXCOLORMASTER_OT_IsolateChannel(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        iso_vcol = mesh.color_attributes.new("Col", 'BYTE_COLOR', 'CORNER')
